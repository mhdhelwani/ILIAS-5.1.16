...
*/
	...
	*/
	...
	public function saveCurrentSolution($active_id, $pass, $value1, $value2, $authorized = true)
	{
        ...
        if ($this->getQuestionType() === "assFileUpload" && $GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')){
            require_once('./Customizing/global/plugins/Services/UIComponent/UserInterfaceHook/CopyRight/classes/Helper/class.copyrightHelper.php');
            ...
            copyrightHelper::_updateCopyRightOptionByObjectId(
                ...
                $active_id,
                "tst_solutions|" . $value1 . "|" . $next_id . "|" . $this->test_id .
                "|" . $value2  . "|" . $this->getId()
            );
