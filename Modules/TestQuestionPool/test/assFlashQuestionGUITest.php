...
*/
class assFlashQuestionGUITest extends PHPUnit_Framework_TestCase
{
	...
	{
		// Arrange
		require_once './Modules/TestQuestionPool/classes/class.assFlashQuestionGUI.php';

		// Act
		$instance = new assFlashQuestionGUI();

		$this->assertInstanceOf('assFlashQuestionGUI', $instance);
	}
}
