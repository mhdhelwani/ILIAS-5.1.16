...
class ilDataCollectionRecordField {
     ...
     * @return mixed
     */
    public function getCopyRightOption()
    {
        return $this->copyRightOption;
    }

    /**
     * @param mixed $copyRightOption
     */
    public function setCopyRightOption($copyRightOption)
    {
        $this->copyRightOption = $copyRightOption;
    }
...
//					$this->record->deleteFile($old); // Removed due to #0018064
	...
	public function setValueFromForm(&$form) {
		...
		$this->setCopyRightOption($form->getInput("copy_right_option_" . $this->field->getId()));
        ...
        if ($value === -1){
        	...
        	copyrightHelper::_deleteCopyRightOptionByObjectId($this->getValue(), null, null);
		}
