...
class ilObjFileGUI extends ilObject2GUI
{
	...
	*/
	public function initSingleUploadForm()
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $in_file->addSubItem(copyrightHelper::_getCopyRightActiveOptionRadio("select_list_title", "copy_right_option"));
        }
	...
	*/
	function save()
	{
		...
		if ($single_form_gui->checkInput())
		{
            ...
            $copy_right_option = $single_form_gui->getInput("copy_right_option");
	...
	*/
	public function initZipUploadForm($a_mode = "create")
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $in_file->addSubItem(copyrightHelper::_getCopyRightActiveOptionRadio("select_list_title", "copy_right_option_zip"));
        }
		...
		if ($this->checkPermissionBool("create", "", "file"))
		{
			if ($zip_form_gui->checkInput())
			{
				...
				try 
				{
                    ...
                    $copy_right_option_zip_file = $zip_form_gui->getInput("copy_right_option_zip");
	...
	*/
	function update()
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            copyrightHelper::_updateCopyRightOptionByObjectId(
                $this->object->getId(),
                $form->getInput('copy_right_option'),
                0,
                "file"
            );
        }
	...
	*/
	function edit()
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $val['copy_right_option'] = copyrightHelper::_getCopyRightValue(
                $this->object->getId(),
                null,
                "file"
            );
	...
	//		$file->enableFileNameSelection('title');
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $form->addItem(copyrightHelper::_getCopyRightActiveOptionRadio("select_list_title", "copy_right_option"));
        }
	...
	*/
	...
	protected function handleFileUpload($file_upload) 
	{
        ...
        $copy_right_option = ilUtil::stripSlashes($file_upload["copy_right_option"]);
        $copy_right_option_zip_file= ilUtil::stripSlashes($file_upload["copy_right_option_zip_file"]);
