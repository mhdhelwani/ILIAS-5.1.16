...
class ilBookingObjectGUI
{
	...
	function initForm($a_mode = "create", $id = NULL)
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $copyRightOptionInfo = copyrightHelper::_getCopyRightActiveOptionRadio("select_list_title", "copy_right_option_book_info_file");
            $copyRightOptionInfo->setRequired(false);
            $form_gui->addItem($copyRightOptionInfo);
        }
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $copyRightOptionPost = copyrightHelper::_getCopyRightActiveOptionRadio("select_list_title", "copy_right_option_book_post_file");
            $copyRightOptionPost->setRequired(false);
            $form_gui->addItem($copyRightOptionPost);
        }
		...
		if ($a_mode == "edit")
		{
            ...
            if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
                ...
                $copyRightValueInfo = copyrightHelper::_getCopyRightValue($obj->getPoolId(), $id, "book_info_file");
                $copyRightValuePost = copyrightHelper::_getCopyRightValue($obj->getPoolId(), $id, "book_post_file");
                $copyRightOptionInfo->setValue($copyRightValueInfo);
                $copyRightOptionPost->setValue($copyRightValuePost);
            }
		...
		if($form->checkInput())
		{
			...
			if($_FILES["file"]["tmp_name"]) 
			{
                ...
                if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
                    ...
                    copyrightHelper::_updateCopyRightOptionByObjectId($this->pool_id, $form->getInput("copy_right_option_book_info_file"), $obj->getId(),"book_info_file");
                }
			...
			else if($file->getDeletionFlag())
			{
                ...
                copyrightHelper::_deleteCopyRightOptionByObjectId($this->pool_id, $obj->getId(),  "book_info_file");
			...
			if($_FILES["post_file"]["tmp_name"]) 
			{
                ...
                if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
                    ...
                    copyrightHelper::_updateCopyRightOptionByObjectId($this->pool_id, $form->getInput("copy_right_option_book_post_file"), $obj->getId(),"book_post_file");
                }
			...
			else if($pfile->getDeletionFlag())
			{
                ...
                copyrightHelper::_deleteCopyRightOptionByObjectId($this->pool_id, $obj->getId(),  "book_post_file");
	...
	function delete()
	{
        ...
        copyrightHelper::_deleteCopyRightOptionByObjectId($this->pool_id, $_POST['object_id'],  null);
