...
class ilBookingObject
{
	...
	public function doClone($a_pool_id, $a_schedule_map = null)
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            copyRightHelper::_updateCopyRightOptionByObjectId($a_pool_id,
                copyRightHelper::_getCopyRightValue($this->getPoolId(), $this->getId(), "book_post_file"),
                $new_obj->getId(),
                "book_post_file");
            copyRightHelper::_updateCopyRightOptionByObjectId($a_pool_id,
                copyRightHelper::_getCopyRightValue($this->getPoolId(), $this->getId(), "book_info_file"),
                $new_obj->getId(),
                "book_info_file");
        }
