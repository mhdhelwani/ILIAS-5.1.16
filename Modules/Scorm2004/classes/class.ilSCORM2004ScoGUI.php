	...
	*/
	...
	function import()
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $tpl->setCurrentBlock("copy_right_option");
			$copyRightPlugin = new ilCopyRightPlugin();
			$copyRightRadio = copyrightHelper::_getCopyRightActiveOptionRadio("", "copy_right_option")->render();

            $tpl->setVariable("TEXT_COPY_RIGHT", $copyRightPlugin->txt('select_list_title'));
            $tpl->setVariable("COPY_RIGHT_PLUGIN_IS_ACTIVE", ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')));
            $tpl->setVariable("COPY_RIGHT_OPTIONS", $copyRightRadio);
            $tpl->parseCurrentBlock();
        }
	...
	function importSave()
	{
        ...
        // patch start 'mhd_helwani'
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            $newPack->setCopyRightOption($_POST["copy_right_option"]);
        }
