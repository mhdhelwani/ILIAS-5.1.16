...
; (function ($, window, document, undefined)
{
    ...
    var ilFile = function (id, file, fileUpload, uploadData)
    {
        ...
        this.loadHtmlTemplate = function (templateId)
        {
            ...
            var tab = tmpl(templateId, this);

            tab = tab.replace(/<!-- <script/g, "<script");
            tab = tab.replace(/script> -->/g, "script>");
            ...
            if (this.canExtract)
            {
                ...
                $html.find(".ilFileUploadEntryCopyRightOptionZipFile").hide();
        ...
        this.getFormData = function ()
        {
            ...
            var copyRightOptionValue = $html.find("input[name='copy_right_option_"+ this.id + "']:checked").val();
            var copyRightOptionZipFileValue = $html.find("input[name='copy_right_option_zip_file_"+ this.id + "']:checked").val();
            ...
            return { title: titleValue, description: descValue, extract: extractValue, keep_structure: keepStructureValue /* patch start 'mhd_helwani' */, copy_right_option: copyRightOptionValue, copy_right_option_zip_file: copyRightOptionZipFileValue /* patch end 'mhd_helwani'*/};
        };
        ...
        function onExtractChanged(e)
        {
            ...
            $html.find(".ilFileUploadEntryCopyRightOptionZipFile").toggle(isChecked);
            $html.find(".ilFileUploadEntryCopyRightOption").toggle(!isChecked);
