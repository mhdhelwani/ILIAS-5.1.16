...
class ilFileUtils
{
	...
	function processZipFile ($a_directory, $a_file, $structure, $ref_id = null, $containerType = null, $tree = null, $access_handler = null /* patch start 'mhd_helwani */, $copy_right_option = null /* patch end 'mhd_helwani */) {
...
//echo "-".$a_directory . "/" . $file."-";
		...
		if ($ref_id != null)
		{
			ilFileUtils::createObjects ($a_directory, $structure, $ref_id, $containerType, $tree, $access_handler /* patch start 'mhd_helwani */, $copy_right_option /* patch end 'mhd_helwani */);
		}
	 ...
	 */	
	function createObjects($dir, $structure, $ref_id, $containerType, $tree = null, $access_handler = null /* patch start 'mhd_helwani */, $copy_right_option = null /* patch end 'mhd_helwani */)
	{
		$dirlist = opendir($dir);
			...
			if ($file != '.' && $file != '..')
			{
				...
				if (is_dir($newpath))
				{
					if ($structure) 
					{
						...
						ilFileUtils::createObjects($newpath, $structure, $new_ref_id, $containerType, $tree, $access_handler /* patch start 'mhd_helwani */, $copy_right_option /* patch end 'mhd_helwani */);
					}
					else 
					{
						ilFileUtils::createObjects($newpath, $structure, $ref_id, $containerType, $tree, $access_handler /* patch start 'mhd_helwani */, $copy_right_option /* patch end 'mhd_helwani */);
					}
				}
				else
				{
					ilFileUtils::createFile (end($level), $dir, $ref_id, $tree, $access_handler /* patch start 'mhd_helwani */, $copy_right_option /* patch end 'mhd_helwani */);
	      			}
			}
		}
		closedir($dirlist);		
	 ...
	 * @param integer $ref_id ref_id of parent
	 */
	public static function createFile ($filename, $path, $ref_id, $tree = null, $access_handler = null /* patch start 'mhd_helwani */, $copy_right_option = null /* patch end 'mhd_helwani */)
	{
