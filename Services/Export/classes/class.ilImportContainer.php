...
class ilImportContainer extends ilImport
{
	 ...
	 * @return 
	 */
	protected function doImportObject($dir, $type /* patch start 'mhd_helwani' */, $a_component = "", $a_tmpdir = "", $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
		...
		if(!$parser->getExportSets())
		{
			...
			$import_info = parent::doImportObject($dir,$type /* patch start 'mhd_helwani' */, "", "", $a_copy_right_option /* patch end 'mhd_helwani' */);
		...
		{
			$import_info = parent::doImportObject($dir.DIRECTORY_SEPARATOR.$set['path'],$set['type']/* patch start 'mhd_helwani' */, "", "", $a_copy_right_option /* patch end 'mhd_helwani' */);
