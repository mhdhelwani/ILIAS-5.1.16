...
class ilImport
{
	...
	final public function importEntity($a_tmp_file, $a_filename,
		$a_entity, $a_component, $a_copy_file = false /* patch start 'mhd_helwani' */, $a_copy_right_option = null/* patch end 'mhd_helwani' */)
	{
		$this->importObject(null, $a_tmp_file, $a_filename, $a_entity, $a_component, $a_copy_file/* patch start 'mhd_helwani' */, $a_copy_right_option /* patch end 'mhd_helwani' */);
	}
	...
	final public function importObject($a_new_obj, $a_tmp_file, $a_filename, $a_type,
		$a_comp = "", $a_copy_file = false/* patch start 'mhd_helwani' */, $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
		...
		$ret = $this->doImportObject($dir, $a_type, $a_comp, $tmpdir/* patch start 'mhd_helwani' */, $a_copy_right_option /* patch end 'mhd_helwani' */);
		$new_id = null;
		if(is_array($ret))
		{
			$new_id = $ret['new_id'];
	 ...
	 * @param	string		absolute filename of temporary upload file
	 */
	protected function doImportObject($dir, $a_type, $a_component = "", $a_tmpdir = ""/* patch start 'mhd_helwani' */, $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
        ...
        $this->copyRightOption = $a_copy_right_option;
	...
	function processItemXml($a_entity, $a_schema_version, $a_id, $a_xml,$a_install_id, $a_install_url)
	{
        ...
        {
            $this->importer->setCopyRightOption($this->copyRightOption);
        }
