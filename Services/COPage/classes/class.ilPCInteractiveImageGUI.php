...
//		$ilTabs->setSubTabActive("cont_new_mob");
	...
	public function initForm($a_mode = "edit")
	{
        ...
        if ( $GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $rightActiveOptionRadio = copyrightHelper::_getCopyRightActiveOptionRadio("select_list_title", "copy_right_option");
            $form->addItem($rightActiveOptionRadio);
        }
...
//		$media_obj->setStandardType("File");
	...
	function initAddOverlaysForm()
	{
        ...
        if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
            ...
            $fi->addSubItem($copyRightOptionRadio);
        }
				...
				foreach ($_FILES["ovfile"]["name"] as $k => $v)
				{
                    ...
                    if ($GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
                        ...
                        copyrightHelper::_updateCopyRightOptionByObjectId(
                            ...
                            $_POST["copy_right_option"],
                            0,
                            "interactive_overlay_image|" . $name
                        );
                    }
