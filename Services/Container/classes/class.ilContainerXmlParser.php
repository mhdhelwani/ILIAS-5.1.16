...
class ilContainerXmlParser
{
	...
	public function parse($a_root_id /* patch start 'mhd_helwani' */, $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
		...
		{
			$this->initItem($item,$this->mapping->getTargetId() /* patch start 'mhd_helwani' */, $a_copy_right_option /* patch end 'mhd_helwani' */);
		}
	}
	 ...
	 * @return 
	 */
	protected function initItem($item, $a_parent_node /* patch start 'mhd_helwani' */, $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
		global $ilSetting;
		...
		if(!$new_ref)
		{
			$new_ref = $this->createObject($ref_id,$obj_id,$type,$title,$a_parent_node/* patch start 'mhd_helwani' */, $a_copy_right_option /* patch end 'mhd_helwani' */);
		}
		...
		{
			$this->initItem($subitem, $new_ref/* patch start 'mhd_helwani' */, $a_copy_right_option /* patch end 'mhd_helwani' */);
		}
	 ...
	 * @return 
	 */
	protected function createObject($ref_id,$obj_id,$type,$title,$parent_node/* patch start 'mhd_helwani' */, $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
        ...
        if (in_array($type, ['file', 'bibl']) && $GLOBALS['ilPluginAdmin']->isActive(IL_COMP_SERVICE, 'UIComponent', 'uihk', 'CopyRight')) {
