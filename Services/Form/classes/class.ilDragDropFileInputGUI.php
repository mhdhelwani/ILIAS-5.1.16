	...
	*/
	...
	function checkInput()
	{
		...
		if ($inputValid)
		{
			...
			$_POST[$this->getPostVar()]["copy_right_option"] = isset($_POST["copy_right_option"]) ? $_POST["copy_right_option"] : 1;
			$_POST[$this->getPostVar()]["copy_right_option_zip_file"] = isset($_POST["copy_right_option_zip_file"]) ? $_POST["copy_right_option_zip_file"] : 1;
