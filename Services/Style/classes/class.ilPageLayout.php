...
class ilPageLayout 
{
	...
	*/
	 ...
	 */
	static function import($a_filename, $a_filepath /* patch start 'mhd_helwani' */, $a_copy_right_option = null /* patch end 'mhd_helwani' */)
	{
		include_once("./Services/Export/classes/class.ilImport.php");
		$imp = new ilImport();
		$imp->importEntity($a_filepath, $a_filename,
			"pgtp", "Services/COPage"/* patch start 'mhd_helwani' */, false, $a_copy_right_option /* patch end 'mhd_helwani' */);
	}
